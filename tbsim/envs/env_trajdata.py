         ...
         or (agent_obs['scene_ids'][0] == 'scene-0098') or (agent_obs['scene_ids'][0] == 'scene-0099')
          or (agent_obs['scene_ids'][0] == 'scene-0100') or (agent_obs['scene_ids'][0] == 'scene-0101')
           or (agent_obs['scene_ids'][0] == 'scene-0102') or (agent_obs['scene_ids'][0] == 'scene-0103')
            or (agent_obs['scene_ids'][0] == 'scene-0104') or (agent_obs['scene_ids'][0] == 'scene-0105')
             or (agent_obs['scene_ids'][0] == 'scene-0106') or (agent_obs['scene_ids'][0] == 'scene-0107')
              or (agent_obs['scene_ids'][0] == 'scene-0108') or (agent_obs['scene_ids'][0] == 'scene-0109')):
            return None
        agent_obs = parse_trajdata_batch(agent_obs, overwrite_nan=False, reset=reset)
        agent_obs = TensorUtils.to_numpy(agent_obs,ignore_if_unspecified=True)
        agent_obs["scene_index"] = self.current_agent_scene_index
