...
class DiffuserConfig(AlgoConfig):
    def __init__(self):
        ...
        self.nusc_norm_info = {
            'diffuser': [(2.135494, 0.003704, 0.970226, 0.000573, -0.002965, 0.000309,),
                         (5.544400, 0.524067, 2.206522, 0.049049, 0.729327, 0.023765,)],
            'agent_hist': [(-1.198923, 0.000128, 0.953161, 4.698113, 2.051664,),
                           (3.180241, 0.159182, 2.129779, 2.116855, 0.388149,)],
            'neighbor_hist': [(-0.237441, 1.118636, 0.489575, 0.868664, 0.222984,),
        ...
        self.nuplan_norm_info = {
            'diffuser': [(4.796822, 0.005868, 2.192235, 0.001452, 0.031407, 0.000549,),
                         (9.048500, 0.502242, 3.416214, 0.081688, 5.372146, 0.074966,)],
            'agent_hist': [(-2.740177, 0.002556, 2.155241, 3.783593, 1.812939,),
                           (5.212748, 0.139311, 3.422815, 1.406989, 0.298052,)],
            'neighbor_hist': [(-0.405011, 1.321956, 0.663815, 0.581748, 0.162458,),
...
class STRIVEConfig(BehaviorCloningConfig):
    def __init__(self):
        ...
        # nusc_train_val, hist=10, fut=20
        self.nusc_norm_info = {
            'agent_hist': [(-0.453062, 0.000294, 1.089531, 5.839054, 2.054347,),
                           (1.201422, 0.048892, 2.376539, 1.791524, 0.379787,)],
            'neighbor_hist': [(-0.203397, 1.064796, 0.637057, 1.171413, 0.297763,),
                              (8.696633, 8.639190, 1.797830, 2.566643, 0.866921,)],
        }
...
class SceneDiffuserConfig(AlgoConfig):
    def __init__(self):
        ...
        self.neighbor_inds = [0, 1, 2, 3, 4, 5, 9,
                              10]  # [0,1,2,3,4,5] # inds of info used in edge corresponding to (x,y,cos,sin,speed,l,w) or (x,y,cos,sin,velx,vely,l,w,rel_d,rel_d_lw, rel_t_to_collision)
        ...
        self.nusc_norm_info = {
            'diffuser': [(2.308888, -0.004272, 1.030073, 0.000432, -0.004650, 0.000229,),
                         (5.253208, 0.494499, 2.126455, 0.046915, 0.632508, 0.021437,)],
            'agent_hist_diff': [(-1.268214, 0.003279, 1.426153, -0.000207, -0.009448, -0.000218,),
                                (2.970397, 0.152488, 3.195604, 0.027117, 29.687944, 0.054703,)],
            'agent_hist': [(-1.306818, 0.003479, 1.057708, 4.849725, 2.082991,),
                           (3.057464, 0.159666, 2.134414, 1.338733, 0.358624,)],
            'neighbor_hist': [(0.299714, 1.586693, 0.580586, 1.351683, 0.341308,),
                              (13.234150, 12.151883, 1.452567, 2.618240, 0.925493,)],
            'neighbor_fut': [(0.574813, 1.412446, 0.436985, 0.834127, 0.214287,),
                             (10.500033, 8.795879, 1.412703, 2.606573, 0.894968,)]
        }
        ...
        self.nuplan_norm_info = {
            'diffuser': [(4.317393, 0.005299, 2.007901, 0.001517, 0.027003, 0.000730,),
                         (8.128303, 0.436614, 3.379836, 0.067413, 4.997261, 0.073624,)],
            'agent_hist_diff': [(-2.366227, 0.002367, 2.254006, -0.000930, -0.009220, 0.000224,),
                                (4.653337, 0.123767, 4.684658, 0.047780, 54.973598, 0.105584,)],
            'agent_hist': [(-2.428304, 0.002483, 2.006769, 4.890794, 2.027937,),
                           (4.738251, 0.130210, 3.472377, 0.534438, 0.129952,)],
            'neighbor_hist': [(1.744586, 2.933562, 1.482359, 1.375110, 0.569008,),
                              (17.750463, 11.847486, 2.611224, 2.349849, 0.865068,)],
            'neighbor_fut': [(4.236001, 2.346138, 1.454897, 0.958200, 0.352373,),
                             (15.373465, 10.320680, 2.627709, 2.209175, 0.796853,)],
        }
